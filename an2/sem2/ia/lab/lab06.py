...
class InfoJoc:
        ...
        for linie in range(InfoJoc.NR_COLOANE):
            for coloana in range(InfoJoc.NR_COLOANE):
                if self.matr[linie][coloana] == InfoJoc.GOL:
                    ...
                    matrNoua[linie][coloana] = jucator
                    listaMutari.append(InfoJoc(matrNoua))
        return listaMutari
    ...
    def linii_deschise(self, jucator):
        return self.linie_deschisa(self.matr[0], jucator) + self.linie_deschisa(self.matr[1], jucator) + self.linie_deschisa(self.matr[2], jucator) \
...
class Stare:
    ...
    def __init__(self, tabla_joc, j_curent, adancime, parinte=None, estimare=None):
        ...
        # restul de adancime in arborele de stari
...
def alpha_beta(alpha, beta, stare):
    ...
    if stare.j_curent == InfoJoc.JMAX:
        ...
        for mutare in stare.mutari_posibile:
            ...
            if mutareCuSubarbore.estimare > scorOptim:
